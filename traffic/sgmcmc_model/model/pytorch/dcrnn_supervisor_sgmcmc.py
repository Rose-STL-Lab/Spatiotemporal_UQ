...
from model.pytorch.sgmcmc import Sampler
    ...
    def _train(self, base_lr,
        ...
        for epoch_num in range(self._epoch_num, epochs):
            ...
            for _, (x, y) in enumerate(train_iterator):
                ...
                if batches_seen == 0: 
                    sampler = Sampler(self.dcrnn_model, self._compute_loss, momentum=0.0, lr=base_lr, wdecay=0.0, T=0.01, total=23872, L2_weight = 0.3)
