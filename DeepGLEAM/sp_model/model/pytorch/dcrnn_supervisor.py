...
from model.pytorch.loss import spline_quantile_loss
...
class DCRNNSupervisor:
    ...
    def load_model(self):
        self._setup_graph()
        assert os.path.exists('week33/models_seed%d/epo%d.tar' % (self.random_seed, self._epoch_num)), 'Weights at epoch %d not found' % self._epoch_num
        checkpoint = torch.load('week33/models_seed%d/epo%d.tar' % (self.random_seed, self._epoch_num), map_location='cpu')
    ...
    def evaluate(self, dataset='val', batches_seen=0):
        ...
        with torch.no_grad():
            ...
            for t in range(y_preds.shape[0]):
                ...
                y_preds_scaled.append(y_preds[t])
    ...
    def _compute_loss(self, y_true, y_predicted):
        ...
        return spline_quantile_loss(y_predicted, y_true)
