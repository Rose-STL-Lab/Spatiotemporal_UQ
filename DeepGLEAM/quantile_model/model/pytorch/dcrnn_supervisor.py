...
class DCRNNSupervisor:
    ...
    def load_model(self):
        self._setup_graph()
        assert os.path.exists('week31/models_seed%d/epo%d.tar' % (self.random_seed, self._epoch_num)), 'Weights at epoch %d not found' % self._epoch_num
        checkpoint = torch.load('week31/models_seed%d/epo%d.tar' % (self.random_seed, self._epoch_num), map_location='cpu')
