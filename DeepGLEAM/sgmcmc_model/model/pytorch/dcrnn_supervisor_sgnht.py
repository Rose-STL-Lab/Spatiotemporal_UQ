...
from model.pytorch.sgnht import Sampler
...
class DCRNNSupervisor:
    def __init__(self, adj_mx, **kwargs):
        ...
        # self.standard_scaler_x = self._data['scaler_x']
        ...
        for epoch_num in range(self._epoch_num, epochs):
            ...
            for _, (x, y) in enumerate(train_iterator):
                ...
                if batches_seen == 0:
                    ...
                    sampler = Sampler(self.dcrnn_model, self._compute_loss, momentum=0.9, lr=base_lr, wdecay=0.0, total=109, A = 10.0)

                loss = sampler.step(x, y, batches_seen)

                self._logger.debug(loss / 109.0)

                losses.append(loss / 109.0)
